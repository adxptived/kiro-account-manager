          ...
          {accountInfo && (
            <div className={`p-4 rounded-xl border space-y-3 ${accent.subtleBg} border-primary/10`}>
              <div className="flex items-center justify-between border-b border-primary/10 pb-2">
                <span className="text-sm font-semibold text-foreground/80">{t('editAccount.currentAccountStatus')}</span>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <span className="text-muted-foreground text-xs block mb-1">{t('editAccount.subscriptionPlan')}</span>
                  <span className="font-medium">{accountInfo.subscriptionType}</span>
                </div>
                <div>
                  <span className="text-muted-foreground text-xs block mb-1">{t('editAccount.usageQuota')}</span>
                  <span className="font-medium">
                    {accountInfo.usage.current.toLocaleString()} / {accountInfo.usage.limit.toLocaleString()}
                  </span>
                </div>
                <div>
                  <span className="text-muted-foreground text-xs block mb-1">{t('accounts.daysRemaining')}</span>
                  <span className="font-medium">{accountInfo.daysRemaining ?? '-'} {t('accounts.days')}</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                title={copiedField === 'refreshToken' ? t('common.copied') : t('common.copy')}
              >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                title={copiedField === 'machineId' ? t('common.copied') : t('common.copy')}
              >
            ...
            <>
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    placeholder={t('editAccount.refreshTokenRequired')}
                    value={form.clientId}
                  ...
                  <button
                    ...
                    className={`absolute right-3 top-1/2 -translate-y-1/2 p-1.5 rounded-lg hover:bg-muted/50 cursor-pointer`}
                    title={copiedField === 'clientId' ? t('common.copied') : t('common.copy')}
                  >
